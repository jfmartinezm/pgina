...
set inno=HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Inno Setup 6_is1
...
reg.exe query "%inno%" /v DisplayIcon || (
	@echo cant find DisplayIcon in HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Inno Setup 6_is1
	pause
	exit /b 1
)
